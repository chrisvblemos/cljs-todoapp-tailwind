...
var len__5769__auto___12681 = arguments.length;
var i__5770__auto___12682 = (0);
while(true){
if((i__5770__auto___12682 < len__5769__auto___12681)){
args__5775__auto__.push((arguments[i__5770__auto___12682]));

var G__12683 = (i__5770__auto___12682 + (1));
i__5770__auto___12682 = G__12683;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12610){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12611,G__12612,seq12610__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12633_SHARP_){
return (!((cljs.core.meta(p1__12633_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12650__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12651){var _e__11575__auto__ = e12651;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12654){var _e__11575__auto__ = e12654;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12666 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12667 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12667);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12668__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12666);
}});
...
var temp__5802__auto___12700 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12700)){
var managed_print_level_12701 = temp__5802__auto___12700;
var _STAR_print_level_STAR__orig_val__12671_12702 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12672_12703 = managed_print_level_12701;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12672_12703);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12670_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12670_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12671_12702);
}} else {
job_fn();
}
