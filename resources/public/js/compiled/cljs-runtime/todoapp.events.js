goog.provide('todoapp.events');
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("todoapp.events","initialize-db","todoapp.events/initialize-db",1699803620),(function (_,___$1){
return todoapp.db.default_db;
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-task","add-task",-913525549),(function (db,p__12404){
var vec__12405 = p__12404;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(0),null);
var task_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(1),null);
var task_description = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(2),null);
var task_deadline = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(3),null);
var tasks = new cljs.core.Keyword(null,"tasks","tasks",-1754368880).cljs$core$IFn$_invoke$arity$1(db);
var uuid = todoapp.utils.safe_random_task_uuid(tasks);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"remove-task-uuid","remove-task-uuid",561153597),(function (db,p__12412){
var vec__12413 = p__12412;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12413,(0),null);
var uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12413,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-task-is-done?","set-task-is-done?",-956760885),(function (db,p__12416){
var vec__12417 = p__12416;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12417,(0),null);
var uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12417,(1),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12417,(2),null);
...
//# sourceMappingURL=todoapp.events.js.map
