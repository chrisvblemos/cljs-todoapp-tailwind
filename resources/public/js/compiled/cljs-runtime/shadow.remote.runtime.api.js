...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17319 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17319(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17326 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17326(runtime,key,spec);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17336 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17336(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17344 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17344(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17357 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17357(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17301,callback){
var map__17302 = p__17301;
var map__17302__$1 = cljs.core.__destructure_map(map__17302);
var input = map__17302__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17302__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17302__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
