...
var G__22075 = o;
reagent.impl.template.goog$module$goog$object.set(G__22075,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22085 = o;
reagent.impl.template.goog$module$goog$object.set(G__22085,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22089 = props;
var G__22089__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22089,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22089);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22089__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22094 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22094,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22094;
}
})(),id_class);
...
var G__22095 = (cljs.core.count(argv) - first_child);
switch (G__22095) {
case (0):
...
var vec__22099 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(2),null);
...
var temp__5808__auto___22208 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22208 == null)){
} else {
var key_22209 = temp__5808__auto___22208;
(jsprops.key = key_22209);
}
...
var temp__5808__auto___22213 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22213 == null)){
} else {
var key_22215 = temp__5808__auto___22213;
...
var temp__5808__auto___22220 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22220 == null)){
} else {
var key_22221 = temp__5808__auto___22220;
(jsprops.key = key_22221);
}
...
var temp__5808__auto___22223 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22223 == null)){
} else {
var key_22225 = temp__5808__auto___22223;
(jsprops.key = key_22225);
}
...
var temp__5808__auto___22227 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var ctx = ({});
var vec__22138 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22138,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22138,(1),null);
...
break;
default:
var G__22247 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22248 = compiler;
v = G__22247;
compiler = G__22248;
continue;
...
(reagent.impl.template.t_reagent$impl$template22176.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22176");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22176.
 */
reagent.impl.template.__GT_t_reagent$impl$template22176 = (function reagent$impl$template$__GT_t_reagent$impl$template22176(opts,id,fn_to_element,parse_fn,meta22177){
return (new reagent.impl.template.t_reagent$impl$template22176(opts,id,fn_to_element,parse_fn,meta22177));
});
