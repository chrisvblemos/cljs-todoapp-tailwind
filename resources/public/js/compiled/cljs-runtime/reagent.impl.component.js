...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21546 = c;
var G__21546__$1 = (((G__21546 == null))?null:G__21546.prototype);
if((G__21546__$1 == null)){
return null;
} else {
return G__21546__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21566 = c;
...
var or__5045__auto__ = (function (){var G__21646 = c;
var G__21646__$1 = (((G__21646 == null))?null:G__21646.constructor);
if((G__21646__$1 == null)){
return null;
} else {
return G__21646__$1.displayName;
}
})();
...
var G__21651 = c;
var G__21651__$1 = (((G__21651 == null))?null:G__21651.constructor);
if((G__21651__$1 == null)){
return null;
} else {
return G__21651__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21701 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21702 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21702);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21701);
}});
...
var c = this;
var G__21910_22014 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21910_22014 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21910_22014);
}
...
var renders_22017 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22018 = cljs.core.first(cljs.core.vals(renders_22017));
...
if((cljs.core.count(renders_22017) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22017))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22018)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22018], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21954 = o;
reagent.impl.component.goog$module$goog$object.set(G__21954,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21987 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21988 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21988);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21987);
}});
...
var vec__21989 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21989,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21989,(1),null);
...
var G__21992 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21992 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21992);
}
});
}),[]);
